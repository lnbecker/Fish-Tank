...
public abstract class Fish {
	...
	protected void setMovement(MovementStyle style){ //added method
		currentpos = style.getcurrentpos();
		xspeed = style.getxspeed();
		yspeed = style.getyspeed();
		xDirectionChangeFreq = style.getxDirectionChangeFreq();
		yDirectionChangeFreq = style.getyDirectionChangeFreq();
